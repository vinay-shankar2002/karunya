...
# Form implementation generated from reading ui file 'manual_transaction.ui'
#
...
"}")
        ...
        self.gridLayout_194.addWidget(self.radioButton_2, 6, 0, 1, 1)
        ...
        self.textEdit = QTextEdit(self.manual_transaction)
        self.textEdit.setMaximumSize(QSize(16777215, 170))
        self.textEdit.setObjectName("textEdit")
        self.gridLayout_194.addWidget(self.textEdit, 5, 1, 1, 2)
        ...
        self.dateEdit = QDateEdit(self.manual_transaction)
        self.dateEdit.setMaximumSize(QSize(16777215, 40))
        self.dateEdit.setObjectName("dateEdit")
        self.gridLayout_194.addWidget(self.dateEdit, 1, 1, 1, 2)
        self.label = QtWidgets.QLabel(self.manual_transaction)
        ...
        self.gridLayout_194.addWidget(self.label, 0, 0, 1, 3)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_192.setText(_translate("MainWindow", "Withdrawal"))
        self.label_192.setText(_translate("MainWindow", "Date"))
        self.label_195.setText(_translate("MainWindow", "Discription"))
        self.label_194.setText(_translate("MainWindow", "Enter Amount"))
        self.label.setText(_translate("MainWindow", "                                          Manual Transaction"))
        self.radioButton_193.setText(_translate("MainWindow", "Deposit/Intrest"))
        self.label_193.setText(_translate("MainWindow", "Select Bank"))
        self.pushButton_192.setText(_translate("MainWindow", "OK"))
        ...
        self.labelVersion_193.setText(_translate("MainWindow", "Ex: C:Program FilesBlender FoundationBlender 2.82 blender.exe"))
